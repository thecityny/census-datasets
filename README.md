...
5.  <code> pop_age_20102021.csv </code>  : wide population grouped to match nypd datasets
6.  <code> nyc_income_pop_2019.csv </code>: Household income by zip codes
7.  <code> ZCTAS2020.csv </code>: population by race and ethnicity in zipcodes
